...
_ROBOT_COMMAND = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='use_dir', full_name='ZSS.Protocol.Robot_Command.use_dir', index=9,
...
Robots_Command = _reflection.GeneratedProtocolMessageType('Robots_Command', (_message.Message,), {
...
Robot_Command = _reflection.GeneratedProtocolMessageType('Robot_Command', (_message.Message,), {
